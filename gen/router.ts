...
export const registerGetDocumentationFunction = (fn: GetDocumentationFunction) => {
    getDocumentation = fn;
};
...
router
    ...
    .get<GetDocumentationSectionPathParams>("/doc/:documentationId/:sectionId/:subSectionId", async (context) => {
